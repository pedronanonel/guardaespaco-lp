  ...
  return (
    <html lang="pt-BR" className={cn("scroll-smooth")}>
      ...
      <body className="bg-background text-on-background antialiased overflow-x-hidden pb-24 md:pb-0">
        ...
        <a
          className="fixed md:bottom-8 bottom-32 right-6 md:right-8 z-[100] flex items-center gap-3 bg-[#25D366] text-white px-6 py-4 rounded-full font-bold shadow-[0_10px_30px_rgba(37,211,102,0.4)] hover:scale-105 active:scale-95 transition-all duration-300 group"
