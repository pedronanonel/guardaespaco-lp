        ...
        <div className="container mx-auto px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="z-10">
            ...
            <p className="text-xl text-secondary mb-10 max-w-md leading-relaxed">
              Privacidade total e segurança para o que você mais valoriza. O Self Storage definitivo para você ou seu negócio.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 items-start">
              <a
                ...
                className="bg-primary text-on-primary text-lg px-10 py-5 rounded-lg font-bold shadow-xl hover:translate-y-[-2px] transition-all duration-300 active:scale-95 text-center inline-block"
            ...
            <div className="bg-[#2a2b2b] rounded-3xl p-10 flex flex-col justify-between border border-[#656464]/20 hover:border-primary/50 transition-colors">
              ...
              <div className="mt-auto">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full block text-center py-4 rounded-xl font-bold transition-all hover:opacity-90 active:scale-95 text-white"
                  style={{ backgroundColor: "rgb(255, 87, 34)" }}
                >
                  Reservar Box
                </a>
            ...
            <div className="bg-white rounded-3xl p-10 md:p-14 shadow-2xl">
              <form action="#" className="space-y-8">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full block text-center bg-primary text-white text-lg font-black py-5 rounded-lg shadow-xl shadow-primary/20 hover:opacity-90 transition-all active:scale-[0.98]"
